...
public class KafkaProducerConfig<K extends Serializable, V extends SpecificRecordBase> {
    ...
    public Map<String, Object> producerConfig() {
        ...
        LOGGER.info("Got Producerconfig*******{}", kafkaProducerConfigData);
     ...
     * - Wrapper class around Kafka Producer
     * - And it provides some methods to be able to send the data to kafka easily
     * @return
     */
    @Bean
